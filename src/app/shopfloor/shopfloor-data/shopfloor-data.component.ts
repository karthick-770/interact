...
@Component({
  ...
  <div class="row justify-content-center">
   ...
   <div class="zoom">  
  <a routerLink="#">
  <img class="img-fluid mx-auto d-block" src="assets/images/pedashboard.png" alt="profile update" width="100" height="436">
  <p class="text-center">Production Engineer Dashboard</p>
  </a>
  </div>
  </div>
  </div>
...
export class ShopfloorDataComponent implements OnInit {
